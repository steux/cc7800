...
{
    char counter = 255;
    char i, j, x, y, xspaceship, yspaceship;
    char *gfxptr;
    ...
    *P3C3 = multisprite_color(0x43); // Red
    ...
    do {
        ...
        if (joystick[0] & JOYSTICK_BUTTON1) {
            if (!button_pressed) {
                ...
                if (nbmissiles != MISSILES_NB_MAX) {
                    X = nbmissiles;
                    xmissile[X] = xspaceship;
                    ymissile[X] = yspaceship;
                    nbmissiles = ++X;
                }
            }
        ...
        // Draw exhaust
        if (exhaust_state > 0 && yspaceship < 224 - 25 - 16) {
            y = yspaceship + 24;
            if (exhaust_state < 10) {
                x = xspaceship + 2;
        ...
        multisprite_display_big_sprite(xspaceship, yspaceship, spaceship, 6, 0, 2, 1);
